        ...
        try {
            ...
            if(havePermission === 0) {
                if(up !== 0.0 && price > up &&  $("body").data("notificationup") != 'no') {
                    window.webkitNotifications.createNotification($("#soundalerter-js-tag").data('upimage'), "Price Alert!!",  "Price of "+tradeType+" went up to " + up).show();      
                ...
                if(down !== 0.0 && price < down && $("body").data("notificationdown") != 'no') {
                    window.webkitNotifications.createNotification($("#soundalerter-js-tag").data('downimage'), "Price Alert!!",  "Price of "+tradeType+" went down to " + down).show();                    
